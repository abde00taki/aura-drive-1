...
import { Clock, ThumbsUp, Zap, MapPin } from 'lucide-react';
...
export default function Home() {
  ...
  const popularCars = cars.slice(0, 3); // Just show 3 cars on home
  ...
  return (
    <>
      ...
      <section className="py-24 bg-dark dark:bg-[#121212] transition-colors duration-300">
          ...
          >
            {cars.map((car) => (
              <SwiperSlide key={`slider-${car.id}`} className="max-w-[300px] sm:max-w-[400px] md:max-w-[500px]">
                <div className="relative group rounded-2xl overflow-hidden border border-black/5 dark:border-white/5 bg-white dark:bg-[#242424] shadow-xl shadow-black/5 transition-colors duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <h3 className="text-2xl font-bold text-white mb-1 drop-shadow-md">{car.name}</h3>
